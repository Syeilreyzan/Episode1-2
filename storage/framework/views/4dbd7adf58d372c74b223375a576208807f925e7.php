                ...
                <form wire:submit.prevent="submitForm" action="/contact" method="POST" class="grid grid-cols-1 row-gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <input wire:model="name" id="name" name="name" value="<?php echo e(old('name')); ?>"
...
unset($__errorArgs, $__bag); ?> form-input block w-full py-3 px-4 placeholder-gray-500 transition ease-in-out duration-150"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <input wire:model="email" id="email" type="text" name="email" value="<?php echo e(old('email')); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <input wire:model="phone" id="phone" name="phone" value="<?php echo e(old('phone')); ?>"
...
<?php /**PATH /Users/muhammadsyaiful/Documents/Project/laraveltesting/resources/views/livewire/contact-form.blade.php ENDPATH**/ ?>